...
object test02_kafka_streaming3 {
  def main(args: Array[String]): Unit = {
    ...
    value.foreachRDD(rdd => {
      val df = rdd.toDF("traceId", "appName", "deviceType", "version", "ip", "sysTime", "userAgent", "txnType", "txnCode", "txnSubCode", "refCode", "txnValue", "event", "subEvent", "userId", "extend")
